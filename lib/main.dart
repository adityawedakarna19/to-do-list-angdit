...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      title: 'Todo List Aditya Wedakarna',
      // Tema warna aplikasi yang lebih menarik
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color.fromARGB(255, 240, 190, 137), // Warna ungu modern
          primary: const Color.fromARGB(255, 240, 226, 137),
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text(
                'Apakah kamu yakin mau menghapus task ini?',
          ...
          children: [
            ...
            Text(
              tasks.isEmpty
                  ...
                  : '✨ Kamu punya ${tasks.length} task${tasks.length > 1 ? 's' : ''} untuk diselesaikan',
              style: TextStyle(
                fontSize: 14,
                color: tasks.isEmpty
